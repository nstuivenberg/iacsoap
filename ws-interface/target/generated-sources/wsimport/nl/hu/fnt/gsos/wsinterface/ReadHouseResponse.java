...
@XmlRootElement(name = "readHouseResponse", namespace = "http://iac.nl.schemas/readHouseResponse")
public class ReadHouseResponse {

    @XmlElement(namespace = "http://iac.nl.schemas/readHouseResponse", required = true)
    protected String straatnaam;
    @XmlElement(namespace = "http://iac.nl.schemas/readHouseResponse")
