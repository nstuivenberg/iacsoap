...
@XmlRootElement(name = "createHouseRequest", namespace = "http://iac.nl.schemas/createHouseRequest")
public class CreateHouseRequest {

    @XmlElement(namespace = "http://iac.nl.schemas/createHouseRequest", required = true)
    protected String straatnaam;
    @XmlElement(namespace = "http://iac.nl.schemas/createHouseRequest")
