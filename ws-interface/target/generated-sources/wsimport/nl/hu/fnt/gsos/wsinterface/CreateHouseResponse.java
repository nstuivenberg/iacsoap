...
@XmlRootElement(name = "createHouseResponse", namespace = "http://iac.nl.schemas/createHouseResponse")
public class CreateHouseResponse {

    @XmlElement(namespace = "http://iac.nl.schemas/createHouseResponse", required = true)
    protected String straatnaam;
    @XmlElement(namespace = "http://iac.nl.schemas/createHouseResponse")
