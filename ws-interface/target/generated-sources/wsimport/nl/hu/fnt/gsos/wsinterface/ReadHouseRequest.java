...
@XmlRootElement(name = "readHouseRequest", namespace = "http://iac.nl.schemas/readHouseRequest")
public class ReadHouseRequest {

    @XmlElement(namespace = "http://iac.nl.schemas/readHouseRequest", required = true)
    protected String straatnaam;
    @XmlElement(namespace = "http://iac.nl.schemas/readHouseRequest")
