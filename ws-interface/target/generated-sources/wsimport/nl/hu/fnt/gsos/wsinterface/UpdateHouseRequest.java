...
@XmlRootElement(name = "updateHouseRequest", namespace = "http://iac.nl.schemas/updateHouseRequest")
public class UpdateHouseRequest {

    @XmlElement(namespace = "http://iac.nl.schemas/updateHouseRequest", required = true)
    protected String straatnaam;
    @XmlElement(namespace = "http://iac.nl.schemas/updateHouseRequest")
